...
export function Card(props: CardProps) {
  ...
  return (
    <div className="w-[220px] relative group">
      <div className="hidden group-hover:absolute group-hover:top-0 group-hover:left-0 group-hover:right-0 group-hover:h-[330px] group-hover:bg-black group-hover:z-20 group-hover:flex group-hover:flex-col group-hover:items-center group-hover:justify-center group-hover:gap-12">
